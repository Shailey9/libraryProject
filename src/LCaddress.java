...
public class LCaddress extends javax.swing.JFrame {
    static LCaddress dialog;
    Connection con;
    Statement stmt;
    ResultSet rs;
    static String lib;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("CHANGE ADDRESS");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(200, 60, 390, 70);

        jLabel2.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("NEW ADDRESS*");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(230, 160, 120, 30);

        jLabel3.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("PASSWORD");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(230, 240, 90, 30);
        ...
        jTextField1.setBounds(380, 160, 180, 22);
        ...
        jPasswordField1.setBounds(380, 240, 180, 23);
        ...
        jButton1.setBounds(430, 310, 90, 25);
        ...
        jCheckBox1.setBounds(380, 270, 130, 25);

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("-------------------------------------------------------------------------------------");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(200, 110, 440, 16);

        jLabel7.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("CITY*");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(230, 200, 120, 30);
        ...
        jTextField2.setBounds(380, 200, 180, 22);
    ...
    private void ok(){
        try {
            ...
            String sql = "update librarian set address = '"+jTextField1.getText()+"', city = '"+jTextField2.getText()+"' where id = "+lib+" ";
