...
public class ACcontact extends javax.swing.JFrame {
    static ACcontact dialog;
    Connection con;
    Statement stmt;
    ResultSet rs;
    ...
    private void ok(){
        ...
        try{
           ...
           valid = 1;
                  ...
                  w.setSize(650,360);
                  w.setVisible(true);
                  w.SetError("ERROR:  Contact should only be in digits. ");
        }
        if(valid == 1){
        if( jTextField1.getText().trim().length() < 13 && jTextField1.getText().trim().length() >9  ){
        try {
            ...
            if(count == 1){
            String sql = "update admin set contact = "+jTextField1.getText()+" where name = '"+admin+"' ";
            ...
            if( n == 1 )
             { 
                  ...
                  w.setSize(650,360);
                  w.setVisible(true);
                  w.SetError("ERROR:  Contact length isn't valid.");
