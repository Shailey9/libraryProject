...
public class LCcontact extends javax.swing.JFrame {
    static LCcontact dialog;
    Connection con;
    Statement stmt;
    ResultSet rs;
    static String lib;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("CHANGE CONTACT");
        jPanel1.add(jLabel6);
    ...
    private void ok(){
        ...
        if( jTextField1.getText().trim().length() == 0 ){
                  ...
                  w.setSize(650,360);
                  w.setVisible(true);
                  w.SetError("ERROR:  Fields won't be Null.");
        }else{
        try{
            ...
            valid = 1;
                  ...
                  w.setSize(650,360);
                  w.setVisible(true);
                  w.SetError("ERROR:  Contact field only have Integer values.");
        }if(valid == 1 ){
        if( jTextField1.getText().length() < 10 || jTextField1.getText().length() > 12 ){
                  Wrong w = new Wrong();
                  w.setSize(650,360);
                  w.setVisible(true);
                  w.SetError("ERROR:  Contact's length isn't valid.");
        }else{
        try {
            ...
            if(count == 1){
            String sql = "update librarian set contact = "+jTextField1.getText()+" where id = "+lib+" ";
