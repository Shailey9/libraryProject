...
public class SendEBooks extends javax.swing.JFrame {
    Connection con;
    Statement stmt;
    ResultSet rs;
    
   static SendEBooks obj;
   ArrayList<String> f = new ArrayList();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Send E-Books");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(300, 70, 420, 80);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Sendmail2.smail(jTextField1.getText(), "StrikInnov:PUSSGRC, Sending E-Books", "Dear Student,\n\n");
