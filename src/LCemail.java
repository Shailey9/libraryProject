...
public class LCemail extends javax.swing.JFrame {
    static LCemail dialog;
    Connection con;
    Statement stmt;
    ResultSet rs;
    static String lib;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(220, 210, 120, 30);

        jLabel3.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("CURRENT PASSWORD:");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(220, 170, 170, 30);
        ...
        jTextField1.setBounds(390, 210, 180, 22);
        ...
        jPasswordField1.setBounds(390, 170, 180, 23);
    ...
    private void ok(){
      try {
            String q = "select * from librarian where id = "+lib+" and password = '"+jPasswordField1.getText()+"' ";
            ...
            if( email.equalsIgnoreCase(jTextField1.getText()) ) {
               Wrong w = new Wrong();
               w.setSize(650,360);
               w.setVisible(true);
               w.SetError("Error : You have Already Registered with this Email.\n\tTry Again with an another one.");
                  ...
                  LCemail.dialog.setCursor(Cursor.WAIT_CURSOR);
                  int x =Sendmail.smail( jTextField1.getText(), "StrikInnov:PUSSGRC, Your Google Account has registered.", "Dear User,\nUnder Librarian Session(StrikInnov:PUSSGRC),someone registered with your Google Account. If that weren't you please immediately change your login credentials.\n\nThankyou.");
                  LCemail.dialog.setCursor(Cursor.DEFAULT_CURSOR);
                  if(x == 1)
                   { 
                      String usql = "update librarian set email  = '"+jTextField1.getText()+"' where id = "+lib+" ";
