...
public class ViewBooks extends javax.swing.JFrame {
    ...
    private void fetch(){
      try {
            ...
            while(rs.next())
             {
                model.addRow(new Object[]{" "+rs.getString("call_no")," "+rs.getString("name")," "+rs.getString("aname")," "+rs.getString("publisher")," "+rs.getString("quantity")," "+rs.getString("issued")," "+rs.getString("idate") } );
             }
        } catch (Exception ex) {
                Wrong d = new Wrong();
                d.setSize(650,360);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(330, 100, 370, 60);

        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(140, 180, 840, 16);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book_ID", "Book_Name", "Author", "Publisher", "Total", "Issued", "Date"
            }
        ));
        ...
        jScrollPane1.setBounds(50, 260, 920, 320);

        jComboBox1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Book_ID", "Book_Name", "Issued" }));
        ...
        jComboBox1.setBounds(370, 630, 120, 20);

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Sorted_By:");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(300, 630, 63, 20);

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Search_By:");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(550, 630, 70, 20);

        jComboBox2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Book_ID", "Book_Name", "Author", "Publisher" }));
        jComboBox2.setPreferredSize(new java.awt.Dimension(94, 30));
        jPanel1.add(jComboBox2);
        jComboBox2.setBounds(630, 630, 130, 20);

        jTextField1.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jPanel1.add(jTextField1);
        jTextField1.setBounds(630, 670, 190, 22);
        ...
        jButton1.setBounds(850, 670, 90, 25);
        ...
        jButton3.setBounds(90, 630, 120, 25);

        getContentPane().add(jPanel1, java.awt.BorderLayout.CENTER);

        setSize(new java.awt.Dimension(1004, 731));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        jobj.setEnabled(true);
        this.dispose();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        switch (jComboBox1.getSelectedIndex()) {
            case 0:
                sql = "select * from book order by call_no ASC";
                break;
            case 1:
                sql = "select * from book order by name ASC";
                break;
            case 2:
                sql = "select * from book order by issued ASC";
                break;
            default:
                break;
        }
try {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        switch (jComboBox2.getSelectedIndex()) {
            case 0:
                    sql = "select * from book where call_no = '"+data+"' ";
                    break;
            case 1:
                    sql = "select * from book where name like '%"+data+"%' ";
                    break;
            case 2:
                    sql = "select * from book where aname like '%"+data+"%' ";
                    break;
            case 3:
